...
- Total exported artifacts: 807
- Effect-returning artifacts: 80
- Layer artifacts: 34
- Re-exports: 500
- Boundary crossings: 18
- Forbidden durable-core layer crossings: 0
- File import boundary crossings: 10
- File import forbidden durable-core layer crossings: 10
...
| Physical Area | Count |
| --- | --- |
| packages/substrate:schema | 189 |
| packages/substrate:choreography | 120 |
| packages/substrate:descriptors | 115 |
...
| apps/lab:lab | 8 |
| packages/client:client | 7 |
| packages/substrate:id-gen | 6 |
...
| --- | --- | --- | --- | --- | --- | --- |
| packages/substrate / choreography / choreography | 120 | 0 | 9 | 80 | 0 | 0 |
| packages/substrate / schema / protocol | 114 | 6 | 0 | 76 | 0 | 0 |
| packages/substrate / descriptors / protocol | 103 | 0 | 0 | 78 | 9 | 0 |
| packages/substrate / schema / state-machine | 66 | 29 | 0 | 45 | 0 | 0 |
| packages/client / firegrid / client-public | 61 | 0 | 4 | 38 | 0 | 0 |
| packages/substrate / facade / facade | 40 | 0 | 4 | 30 | 0 | 1 |
| packages/substrate / subscribers / state-machine | 34 | 12 | 0 | 17 | 0 | 1 |
| packages/substrate / waits / state-machine | 34 | 0 | 2 | 17 | 0 | 2 |
| packages/runtime / runtime / runtime-core | 31 | 6 | 5 | 9 | 0 | 0 |
| packages/substrate / facade / projection | 28 | 0 | 4 | 21 | 0 | 0 |
| packages/substrate / event-plane / projection | 20 | 1 | 0 | 12 | 0 | 0 |
| packages/substrate / producer / state-machine | 20 | 0 | 2 | 10 | 0 | 1 |
...
| packages/substrate / event-plane / event-plane | 11 | 0 | 1 | 5 | 0 | 2 |
...
| packages/client / client / client-work-internal | 7 | 0 | 1 | 0 | 0 | 0 |
| packages/substrate / descriptors / state-store | 6 | 3 | 0 | 4 | 0 | 0 |
| packages/substrate / descriptors / substrate-root | 6 | 6 | 0 | 4 | 0 | 0 |
| packages/substrate / id-gen / substrate-root | 6 | 0 | 2 | 3 | 0 | 0 |
| packages/substrate / internal-claim / state-machine | 4 | 2 | 0 | 2 | 0 | 1 |
| packages/runtime / boot / runtime-boot | 1 | 0 | 0 | 0 | 1 | 0 |
...
| OperationHandle | constant | packages/substrate/src/descriptors/operation.ts | packages/client/src/firegrid/operation-client.ts | re-export-crosses-workspace: packages/substrate -> packages/client |
| OperationHandle | constant | packages/substrate/src/descriptors/operation.ts | packages/client/src/index.ts | re-export-crosses-workspace: packages/substrate -> packages/client |
...
| --- | --- | --- | --- | --- |
| packages/substrate/src/internal-claim.ts | import-crosses-forbidden-layer | state-machine -> substrate-root | ./id-gen.ts | packages/substrate/src/id-gen.ts |
| packages/substrate/src/producer.ts | import-crosses-forbidden-layer | state-machine -> substrate-root | ./id-gen.ts | packages/substrate/src/id-gen.ts |
...
| packages/substrate/src/subscribers.ts | import-crosses-forbidden-layer | state-machine -> choreography | ./choreography/triggers.ts | packages/substrate/src/choreography/triggers.ts |
| packages/substrate/src/waits.ts | import-crosses-forbidden-layer | state-machine -> substrate-root | ./id-gen.ts | packages/substrate/src/id-gen.ts |
| packages/substrate/src/waits.ts | import-crosses-forbidden-layer | state-machine -> choreography | ./choreography/triggers.ts | packages/substrate/src/choreography/triggers.ts |
...
| packages/substrate/src/facade/work.ts | import-crosses-forbidden-layer | facade -> substrate-root | ../id-gen.ts | packages/substrate/src/id-gen.ts |
...
| runOperationDispatchLoopWithAcquire | packages/runtime/src/runtime/internal/operation-handler.ts | Op extends Operation.Any, E, R, E2 | cfg: RuntimeContextService, input: DispatchInput<Op, E, R>, acquire: Effect.Effect<SubstrateStreamDB, E2, Scope.Scope> | void | E2 | Exclude<Exclude<R, CurrentWorkContext>, Scope.Scope> |
| runOperationHandler | packages/runtime/src/runtime/internal/operation-handler.ts | Op extends Operation.Any, E, R | input: DispatchInput<Op, E, R> | void | never | RuntimeContext \| Scope.Scope \| Exclude<Exclude<R, CurrentWorkContext>, Scope.Scope> |
...
| decodeAtBoundary | packages/substrate/src/descriptors/codec.ts | S extends Schema.Schema.All, E | schema: S, mapError: (cause: ParseResult.ParseError) => E | Schema.Schema.Type<S> | E | never |
| encodeAtBoundary | packages/substrate/src/descriptors/codec.ts | S extends Schema.Schema.All, E | schema: S, mapError: (cause: ParseResult.ParseError) => E | Schema.Schema.Encoded<S> | E | never |
| appendChange | packages/substrate/src/descriptors/append.ts | E | target: JsonAppendTarget, change: StateEvent, mapError: (cause: unknown) => E | void | E | never |
| decodeAtBoundary | packages/substrate/src/descriptors/codec.ts | S extends Schema.Schema.All, E | schema: S, mapError: (cause: ParseResult.ParseError) => E | Schema.Schema.Type<S> | E | never |
| encodeAtBoundary | packages/substrate/src/descriptors/codec.ts | S extends Schema.Schema.All, E | schema: S, mapError: (cause: ParseResult.ParseError) => E | Schema.Schema.Encoded<S> | E | never |
...
| decodeAtBoundary | packages/substrate/src/descriptors/codec.ts | S extends Schema.Schema.All, E | schema: S, mapError: (cause: ParseResult.ParseError) => E | Schema.Schema.Type<S> | E | never |
| decodeCompletionData | packages/substrate/src/schema/rows.ts | S extends Schema.Schema.AnyNoContext, E | schema: S, mapError: (cause: ParseResult.ParseError) => E | Schema.Schema.Type<S> | E | never |
| decodeProjectionMatchCompletionData | packages/substrate/src/schema/rows.ts | E | value: unknown, mapError: (cause: ParseResult.ParseError) => E | { readonly deadlineAtMs?: number \| undefined; readonly trigger: { readonly label: string; readonly projectionKey: string; readonly matcherId: string; readonly _tag: "ProjectionMatch"; }; readonly timeoutMs?: number \| undefined; } | E | never |
| encodeAtBoundary | packages/substrate/src/descriptors/codec.ts | S extends Schema.Schema.All, E | schema: S, mapError: (cause: ParseResult.ParseError) => E | Schema.Schema.Encoded<S> | E | never |
...
| ProjectionLive | packages/substrate/src/facade/projection.ts | Projection | ProjectionReadError | never | type-api |
| WorkClaimLive | packages/substrate/src/facade/work.ts | WorkClaim | never | never | type-api |
| IdGenLive | packages/substrate/src/id-gen.ts | IdGen | never | never | type-api |
| ChoreographyLive | packages/substrate/src/choreography/service.ts | Choreography | never | never | type-api |
| currentWorkContextLayer | packages/substrate/src/choreography/context.ts | CurrentWorkContext | never | never | type-api |
| ProjectionLive | packages/substrate/src/facade/projection.ts | Projection | ProjectionReadError | never | type-api |
| triggerMatchersLayer | packages/substrate/src/choreography/triggers.ts | TriggerMatchers | never | never | type-api |

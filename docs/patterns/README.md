...
- [Session timeline events](./eventstream-folded-as-list.md)
...
| Vite plugin imports `@firegrid/runtime` into the browser dev server | Runtime is Node-tier and should be hosted as runtime code, not by the browser bundler | `firegrid-platform-invariants.LOCALITY.1`; `firegrid-agent-runtime-substrate.TOPOLOGY_PROFILE.5` |

...
This proposal breaks the remaining firegrid work into reviewable
...
1. Client event planes and state producers
   ...
   - Spec: `features/firegrid/client-event-plane-registration.feature.yaml`
...
2. Effect pipeline facade
   ...
   - Spec: `features/firegrid/effect-pipeline-facade.feature.yaml`
...
3. Choreography and agent tool bindings
   ...
   - Spec: `features/firegrid/choreography-tool-bindings.feature.yaml`
...
4. Launchable substrate host and lab
   ...
   - Spec: `features/firegrid/launchable-substrate-host.feature.yaml`

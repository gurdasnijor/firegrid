...
| ESLint | `lint` | Style, unsafe TS, restricted imports, production cutover violations | Follow local ESLint error and use public package roots | Includes `scripts/effect-native-production-cutover-check.mjs`. |

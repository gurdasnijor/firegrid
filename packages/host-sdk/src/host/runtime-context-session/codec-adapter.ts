...
// from the host's OWN bound base. Exported as the TFIND-048
// host-provisioning seam so the deterministic gating test can assert
// exactly what the codec start path resolves.

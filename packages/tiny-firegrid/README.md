...
For the operational tracing runbook — exporter boundaries, simulation capture,
heartbeat/watch behavior, `simulate:show`, `simulate:perf`, and the shared
trace helper APIs — see
[`docs/runbooks/firegrid-effect-tracing.md`](../../docs/runbooks/firegrid-effect-tracing.md).

...
export const actionAndRememberSimulation = {
  ...
  localize: result =>
    result.claimStatus === "passed"
      ? [
        "execute returned through the advertised host capability seam, its result was written to app-owned durable evidence, and a later wait/history read observed the same row.",
      ]

...
const gatewayContextId = "session:firelab:shape-c-terminal-ordering-gateway"
...
export const shapeCTerminalOrderingDriver = Effect.gen(function*() {
  ...
  yield* mcp.callTool("session_close", {
    ...
    Effect.withSpan("firelab.shape_c_terminal.driver.session_close", {
      kind: "client",
      attributes: {
  ...
  Effect.withSpan("firelab.shape_c_terminal.driver", {
    kind: "client",
  }),
)

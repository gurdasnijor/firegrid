...
//
// It is intentionally narrower than SubstrateHost — boot plan,
// auth headers, and the user-supplied profile are deliberately not
// part of this Tag. Programs should not reach into host
// configuration; they should compose adapter / provider / event-plane
// layers and let the substrate stream identity drive them.

...
//
// IMMEDIATE RETIREMENT BEAD: tf-z8wq — target-tree amendment merged at
// 45d3642f (see `docs/architecture/2026-05-22-runtime-physical-target-tree.md`
// §Kernel Retirement; the amended tree also defines the canonical
// `engine/` substrate tier). Until the mechanical move per that
// amendment lands, this barrel and its two leaf files
// (runtime-host-config.ts, runtime-context-helpers.ts) survive as named
// residue, NOT as architectural ownership.
//
